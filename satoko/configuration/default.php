<?php
// Satoko Default Configuration
// DON'T EDIT ANYTHING HERE, COPY A VALUE AND PLACE IT IN config.php INSTEAD!!!
...
$satoko['cookiePrefix']     = 'satoko_'; // Prefix used for cookies
...
$satoko['boardSubtitle']    = ''; // Text displayed below the title of the board.
$satoko['boardDescription'] = 'This is an Image Board running the Satoko script.'; // Description read by search engines etc.
